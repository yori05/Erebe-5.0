...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FDialogueChange, FText, CurrentText);

UCLASS( ClassGroup=("Dialogue"), meta=(BlueprintSpawnableComponent), Blueprintable, BlueprintType )
class EREBE_API UDialogueComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected :
	...
	/** Saved interactor  */
	UPROPERTY(Category = "Dialogue", VisibleAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "true"))
		UDialogueComponent* SavedDialoguer;
	...
	UPROPERTY(BlueprintAssignable, BlueprintCallable)
		FDialogueChange OnDialogueLineChange;
...
protected:
	...
	UFUNCTION(BlueprintCallable)
		virtual void ChangeVisibiltyWidget(ESlateVisibility Visibility, UDialogueComponent* OtherDialoguer);

	UFUNCTION(BlueprintCallable)
		virtual FText GetCurrentDialogueLine();

	UFUNCTION(BlueprintCallable)
		virtual void InitializeDialogue(UDialogueComponent* OtherDialoguer);

	UFUNCTION(BlueprintCallable)
		virtual void IncrementeDialogue(UDialogueComponent* OtherDialoguer);

	UFUNCTION(BlueprintCallable)
		virtual void UpdateDialogue(UDialogueComponent* OtherDialoguer);
...
public:
	...
	UFUNCTION(BlueprintCallable)
		virtual void StartConversation_Interaction(UDialogueComponent* OtherDialoguer);
	/** Block the reading if the character is behind the object or not in the front */
	UFUNCTION(BlueprintCallable)
		virtual bool CanStartConversation_Interaction(UDialogueComponent* OtherDialoguer);
	...
	UFUNCTION(BlueprintCallable)
	virtual void StopConversation_Interaction(UDialogueComponent* OtherDialoguer);
	/** Try to start a conversation */
	UFUNCTION(BlueprintCallable)
	virtual bool TryConversation_Interaction(UDialogueComponent* OtherDialoguer);

	UFUNCTION(BlueprintCallable)
		bool IsInDialogue() { return SavedDialoguer != nullptr; }
public :

	FORCEINLINE UDialogueComponent* GetSavedDialoger() { return SavedDialoguer; };
