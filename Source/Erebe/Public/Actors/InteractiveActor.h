...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FInteractiveActorCallback, class AInteractiveActor*, InteractiveActor, APawn*, InteractorPawn, uint8, InteractionID, FName, InteractionName);

/**
 * 
 */
UCLASS()
class EREBE_API AInteractiveActor : public AActor, public IInteractiveInterface
{
	GENERATED_BODY()
...
public:
	...
	FInteractiveActorCallback OnInteract;
...
public :
	/** Returns interactive component subobject */
	FORCEINLINE class UInteractiveComponent* GetInteractiveComponent() { return InteractiveComponent; };
